...
public class Tests {
	...
	public void testSimpleHybrid() {
		...
		BPlusTree<Character, String> tree = new BPlusTree<Character, String>(2);
	...
	public void testSimpleHybrid2() {
		...
		for(int i=0; i<primeNumbers.length; i++) {
			assertEquals(""+primeNumbers[i], tree.exactMatchSearch(primeNumbers[i]));
		}

		tree.delete(2);
		assertEquals(null, tree.exactMatchSearch(2));
	...
	public void testSimpleHybrid3() {
		...
		assertEquals(null, tree.exactMatchSearch(1));
		assertEquals(null, tree.exactMatchSearch(99));
		assertEquals(null, tree.exactMatchSearch(null));
	}
	
	@Test
	public void testSearchEmptyTree() {
		BPlusTree<Integer, String> emptyTree = new BPlusTree<Integer, String>(2);
		assertEquals(null, emptyTree.exactMatchSearch(2));
		assertEquals(null, emptyTree.exactMatchSearch(72));
		assertEquals(null, emptyTree.exactMatchSearch(null));
	}
	...
	public void testLargeTree() {
		...
		assertTrue(treeDepth(tree.getRoot()) < 11);
	}
